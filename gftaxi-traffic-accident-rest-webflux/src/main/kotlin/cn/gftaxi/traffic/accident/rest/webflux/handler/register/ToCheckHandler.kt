 ...
 * @author RJ
 */
@Component("cn.gftaxi.traffic.accident.rest.webflux.handler.register.ToCheckHandler")
class ToCheckHandler @Autowired constructor(
  ...
  companion object {
    ...
    val REQUEST_PREDICATE: RequestPredicate = POST("/accident-register/to-check/{id}")
  }
}