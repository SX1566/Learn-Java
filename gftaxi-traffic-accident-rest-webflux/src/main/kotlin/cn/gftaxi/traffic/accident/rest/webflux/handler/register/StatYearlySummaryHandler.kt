...
/**
 * 事故登记年度汇总统计的 [HandlerFunction]。
 *
 * @author RJ
 */
@Component("cn.gftaxi.traffic.accident.rest.webflux.handler.register.StatYearlySummaryHandler")
class StatYearlySummaryHandler @Autowired constructor(
  ...
  override fun handle(request: ServerRequest): Mono<ServerResponse> {
    ...
    return accidentStatService.statRegisterYearlySummary(from, to).collectList()
      // response
  ...
  companion object {
    ...
    val REQUEST_PREDICATE: RequestPredicate = GET("/accident-register/stat-yearly-summary")
  }
}