...
/**
 * 事故报告月度汇总统计的 [HandlerFunction]。
 *
 * @author zh
 */
@Component("cn.gftaxi.traffic.accident.rest.webflux.handler.report.StatMonthlySummaryHandler")
class StatMonthlySummaryHandler @Autowired constructor(
  ...
  override fun handle(request: ServerRequest): Mono<ServerResponse> {
    ...
    return accidentStatService.statReportMonthlySummary(from, to).collectList()
      // response
  ...
  companion object {
    ...
    val REQUEST_PREDICATE: RequestPredicate = GET("/accident-report/stat-monthly-summary")
  }
}