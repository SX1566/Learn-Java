...
2. [分类标准](#2-)
    - 2.1 [Table](#2-1-table)
    - 2.2 [HTTP](#2-2-http)
        - 2.2.1 [获取指定一级分类下的二级分类列表](#2-2-1-)
    - 2.3. [Service](#2-3-service)
        - 2.3.1 [获取指定一级分类下的二级分类列表](#2-3-1-)
3. [事故报案](#3-)
    - 3.1 [Table](#3-1-table)
    - 3.2 [HTTP](#3-2-http)
        - 3.2.1 [获取独立视图的分页数据](#3-2-1-)
        - 3.2.2 [获取指定编号的报案信息](#3-2-2-)
        - 3.2.3 [提交事故报案信息](#3-2-3-)
        - 3.2.4 [更新事故报案信息](#3-2-4-)
    - 3.3. [Service](#3-3-service)
    - 3.4. [Dao](#3-4-dao)
4. [事故登记](#4-)
    - 4.1 [Table](#4-1-table)
    - 4.2 [HTTP](#4-2-http)
        - 4.2.1 [获取汇总统计信息](#4-2-1-)
        - 4.2.2 [获取待登记和待审核案件信息](#4-2-2-)
        - 4.2.3 [获取已审案件信息](#4-2-3-)
5. [事故报告](#5-)
6. [事故处理](#6-)
7. [事故结案](#7-)
