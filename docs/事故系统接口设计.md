...
| actualDriverReturnTime  | true   | 司机实际回队时间，格式为 yyyy-MM-dd HH:mm
| driverReturnSponsorName | true   | 司机回队主办人姓名
| driverReturnSupporter   | true   | 司机回队协办人姓名
| safetyStartTime         | false  | 安全教育开始时间，格式为 yyyy-MM-dd HH:mm
| safetyEndTime           | false  | 安全教育结束时间，格式为 yyyy-MM-dd HH:mm
| safetySponsorName       | false  | 安全教育主办人姓名
| safetySupporterName     | false  | 安全教育协办人姓名
| talkStartTime           | false  | 诫勉谈话开始时间，格式为 yyyy-MM-dd HH:mm
| talkEndTime             | false  | 诫勉谈话结束时间，格式为 yyyy-MM-dd HH:mm
| talkSponsorName         | false  | 诫勉谈话主办人姓名
| talkSupporterName       | false  | 诫勉谈话协办人姓名
| **_安全教育_** 
...
Name          | Type   | Description
--------------|--------|-------------
scope         | String | 统计范围，可按月份（2018年06月）、季度（2018年第一季度）和年份（2018年）显示
total         | Int    | 事故总数
closed        | Int    | 出险结案案件数，仅含审核通过
checked       | Int    | 在案已审案件数，包含审核不通过
checking      | Int    | 在案在审案件数
